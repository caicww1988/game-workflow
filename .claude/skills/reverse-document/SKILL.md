...
- `client/Source/client/Gameplay/Combat/` → All combat-related code
- `client/Source/client/Core/event-system.cpp` → Specific file
- `prototypes/stealth-mech/` → Prototype directory

**Examples**:
```bash
/reverse-document design client/Source/client/Gameplay/MagicSystem
/reverse-document architecture client/Source/client/Core/entity-component
...
```
I've analyzed client/Source/client/Gameplay/Combat/. Here's what I found:
...
source: client/Source/client/Gameplay/Combat/
date: 2026-02-13
...
|----------------|-----------------|------------|
| `client/Source/client/Gameplay/*` | design-doc-from-implementation.md | Gameplay mechanics → GDD |
| `client/Source/client/Core/*`, `client/Source/client/AI/*` | architecture-doc-from-code.md | Core systems → ADR |
| `prototypes/*` | concept-doc-from-prototype.md | Experiments → concept doc |
| `client/Source/client/Networking/*` | architecture-doc-from-code.md | Technical systems → ADR |
| `client/Source/client/UI/*` | design-doc-from-implementation.md | UI/UX → design spec |
...
```
User: /reverse-document design client/Source/client/Gameplay/Combat

Agent: I'll analyze your combat implementation to create a design doc.
       [Reads code, discovers mechanics, formulas]

Agent: I've analyzed client/Source/client/Gameplay/Combat/. Here's what I found:
